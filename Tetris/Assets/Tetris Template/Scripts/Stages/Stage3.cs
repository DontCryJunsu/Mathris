...
public class Stage3 : MonoBehaviour
{
    ...
    {
        check = true;
        int thisStageScore = StageManager.Instance.numbers[0] * 10 + StageManager.Instance.numbers[1]  + StageManager.Instance.numbers[2] *10+ StageManager.Instance.numbers[3]
            - StageManager.Instance.numbers[4];
        int currentStageScore = PlayerPrefs.GetInt("Total")+thisStageScore;

        PlayerPrefs.SetInt("Total", currentStageScore);
        PlayerPrefs.SetInt("Stage3", thisStageScore);
